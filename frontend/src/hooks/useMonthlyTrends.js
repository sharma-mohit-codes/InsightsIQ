...
/**
 * Custom hook that fetches monthly sales and profit trend data from the backend once on mount.
 *
 * Returns:
 *  - data    {object|array|null} — Monthly trends payload from the API, or null while loading/errored
